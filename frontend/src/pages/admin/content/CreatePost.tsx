...
import { ArrowLeft, Save, Eye, Upload, Plus, X, Image as ImageIcon } from 'lucide-react'
        ...
        <html>
          <head>
            ...
            <style>
              ...
              h1 { color: #2E86AB; }
              .tags { color: #666; margin: 10px 0; }
              .tag { background: #e0e0e0; padding: 2px 8px; border-radius: 12px; margin-right: 5px; }
          ...
          <Card padding="lg">
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-sm text-gray-500 mt-1">Ví dụ: pet care, dog, health</p>
              </div>
